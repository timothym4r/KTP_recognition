...
def prepare_enhance_model(esrgan_model_gdrive):
    ...
    esrgan_model_path = os.path.join("recog_models", recog_model_file_name)
...
def select_recog_model(recog_model_selected):
    ...
    if recog_model_selected == "ResNet50":
        recog_model_path = r"https://drive.google.com/file/d/1J9llUuzdCRtPmqEjzI5fPjwbCj0XDdSt/view?usp=sharing"
        recog_model_file_name = "ResNet50.keras"
    elif recog_model_selected == "VGG16":
        recog_model_path = r" https://drive.google.com/file/d/1vqk2ehrci4M_DwSL7aAt8z-wYB7bonkI/view?usp=drive_link"
...
if selected == "Enhancement":
    ...
    if enhance_button_clicked:
        if st.session_state["show_enhance_option"]:
            ...
            model_path = r"https://drive.google.com/file/d/1Jt8scnQz0Bk548zGUbtnUeIOgkMFjrbl/view?usp=sharing"
